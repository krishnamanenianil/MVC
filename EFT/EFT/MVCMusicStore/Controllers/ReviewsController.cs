...
namespace MVCMusicStore.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReviewId,AlbumId,Contenets,ReviewerEmail")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReviewId,AlbumId,Contenets,ReviewerEmail")] Review review)
        {
            if (ModelState.IsValid)
            {
